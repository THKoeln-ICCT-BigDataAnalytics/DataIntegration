...
DROP SCHEMA IF EXISTS sakila_s1;
CREATE SCHEMA sakila_s1;
USE sakila_s1;
...
-- S1 CHANGE: ALTER TABLE sakila_s1.address DROP COLUMN location; 

-- -- S1 CHANGE: category --> film_category
...
CREATE TABLE city (
  ...
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  country_country VARCHAR(50) NOT NULL,  -- S1 CHANGE: from table country
  PRIMARY KEY  (city_id),
...
CREATE TABLE film_category (
  ...
  last_update TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  category_name VARCHAR(25) NOT NULL, -- S1 CHANGE: from table category
